...
import { getRooms } from '../../slices/gym';
...
const RoomList = () => {
  ...
  const { rooms } = useSelector((state) => state.gym);
  ...
  const filteredCustomers = applyFilters(rooms, filters);
  ...
  return (
    <>
      <Head>
        <title>
          Dashboard: Listado de espacios y salas
        </title>
      </Head>
      <Box
        component="main"
