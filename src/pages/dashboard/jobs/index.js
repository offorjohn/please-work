...
// Esto me importa las Notificaciones de Prueba para el icono de la campana.
// DEBO ELIMINARLO para poner mis propias notificaciones de la base de datos.
import { jobApi } from '../../../__fake-api__/job-api';

// // Esto me importará las notificaciones del modelo de Notifications de la base de datos.
...
const JobBrowse = () => {
  ...
  /* Esto llama a la API que muestra las Notificaciones en el Menu del Icono de la Campana.
  *
  * Esto se hace a través del archivo notification-api.js en la carpeta "api".
  * */
  const getCompanies = useCallback(async () => {
    try {
      const data = await NotificationApi.getCompanies();
