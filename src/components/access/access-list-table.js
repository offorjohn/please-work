...
export const AccessListTable = (props) => {
  const {
    customers,
    customersCount,
    onPageChange,
              ...
              return (
                ...
                selected={isCustomerSelected}>
                    ...
                    >
                      <Box sx={{ ml: 1 }}>
                        ...
                        passHref>
                          ...
                          color="inherit" 
                          variant="subtitle2">
                            {customer.client.first_name} {customer.client.last_name}
                          </Link>
                        </NextLink>
                      </Box>
                    </Box>
                  ...
                  <TableCell>
                    <Typography color="success.main" 
                      variant="subtitle2">
                        {`${format(new Date(customer.date), 'HH:mm:ss')}`}
                      </Typography>
                  </TableCell>
                  <TableCell>
                    <Typography color="success.main" 
                  ...
                  <TableCell align="right">
                    ...
                    {/* Icono de la Flecha */}
                    <NextLink href={`/dashboard/customer/${customer.client.id}`}
                    passHref>
                      <IconButton component="a">
