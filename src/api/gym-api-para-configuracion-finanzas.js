...
/* Esto es la API para Ver y Editar la Configuración de Finanzas del Gimnasio, el cual incluye la Clave de Stripe.
*
...
class GymApi {
  ...
  /* Esto agarra los datos del Gimnasio del Modelo de Gym de la base de datos, paral luego mostrarlos en el Front-end.
  *
